...
class TextView(APIView):
    ...
    def post(self, request):
        ...
        resq = rq.post("http://"+host+":8090/user/login/api/v0/validate/",
                       data=post_token)

        if resq.status_code > 300 or resq.status_code < 200:
            message = "Server or token not available !"
        ...
        if serializer.is_valid():
            ...
            self.fragment_text(text_content, breakpoints,
                               serializer.data['id'])
            return Response('Texto inserido com sucesso',
    ...
    def create_fragment(self, fragment_content, text):
        ...
        '''
        Fragment.objects.create(content=fragment_content,
...
"""
{
    ...
    Aliquam ut tristique ligula. Donec mollis lorem elementum
    purus semper convallis. Etiam ac lectus ac dolor tempus pellentesque non
    eu enim. Integer venenatis neque eget massa blandit, iaculis tincidunt
    tellus egestas. Nunc finibus, elit at sagittis sodales, velit ligula male
    suada nulla, eget mollis turpis ipsum sed mi. Cras non condimentum lectus
    . Suspendisse potenti. Mauris nulla sapien, tempor eget ipsum et, vehicul
    a imperdiet massa. Praesent sed vehicula nulla. Proin sagittis consequat
    lacus sit amet suscipit. Etiam a risus vel leo venenatis ultricies at
    semper ante. Maecenas sed odio mauris.",
    "context": "Hello World",
    "author": 1,
    "language": 1,
